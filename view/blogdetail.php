                    ...
                    <div class="row mb--75">
                            ...
                            <div class="single-post">
                                ...
                                <article class="single-post-details">
                                    ...
                                    <div class="entry-media">
                                        <div class="image">
                                            <img src="../view/assets/img/blog/blog_detail_1.jpg" alt="Post Thumbnail">
                                        </div>
                                    </div>
                                    <div class="entry-content">
                                        ...
                                        <figure class="mb--30 image-with-video-btn btn-center">
                                            <a href="https://www.youtube.com/watch?v=Rp19QD2XIGM" class="video-popup">
                                                <img src="../view/assets/img/blog/blog_detail_2.jpg" alt="blog">
                                    ...
                                    <div class="nav-links">
                                        <div class="nav-prev nav-links__inner">
                                            ...
                                            <div class="nav-links__thumb">
                                                <img src="../view/assets/img/blog/blog-13-100x100.jpg" alt="Prev Post">
                                            </div>
                                        ...
                                        <div class="nav-next nav-links__inner">
                                            ...
                                            <div class="nav-links__thumb">
                                                <img src="../view/assets/img/blog/blog-3-100x100.jpg" alt="Next Post">
                                            </div>
                                            <div class="nav-links__content">
                                    ...
                                    <div class="comment">
                                        <ul class="comment-list">
                                            <li>
                                                <div class="single-comment">
                                                    <div class="comment-avatar">
                                                        <img src="../view/assets/img/others/comment-1.jpg" alt="comment">
                                                    </div>
                                                ...
                                                <ul class="children">
                                                    <li>
                                                        <div class="single-comment">
                                                            <div class="comment-avatar">
                                                                <img src="../view/assets/img/others/comment-2.jpg" alt="comment">
                                                            </div>
                                                            <div class="comment-info">
                                                                <div class="comment-meta">
                                            ...
                                            <li>
                                                <div class="single-comment">
                                                    <div class="comment-avatar">
                                                        <img src="../view/assets/img/others/comment-3.jpg" alt="comment">
                                                    </div>
                                                    <div class="comment-info">
                                                        <div class="comment-meta">
                                                            <h5 class="comment-author"><a href="#">Julia Rebeca</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-4 order-lg-1">
                            <div class="sidebar-inner">
                                ...
                                <div class="widget blog-widget widget-recent-posts mb--40">
                                    ...
                                    <div class="recent-post">
                                        <div class="recent-post__item">
                                            <div class="recent-post__thumb">
                                                <a href="single-post.html">
                                                    <img src="../view/assets/img/blog/blog-1-70x70.jpg" alt="Blog">
                                                </a>
                                            </div>
                                        ...
                                        <div class="recent-post__item">
                                            <div class="recent-post__thumb">
                                                <a href="single-post.html">
                                                    <img src="../view/assets/img/blog/blog-3-70x70.jpg" alt="Blog">
                                                </a>
                                            </div>
                                            <div class="recent-post__content">
                                                <h3 class="recent-post__title text-truncate">
                                        ...
                                        <div class="recent-post__item">
                                            <div class="recent-post__thumb">
                                                <a href="single-post.html">
                                                    <img src="../view/assets/img/blog/blog_beuty-70x70.jpg" alt="Blog">
                                                </a>
                                            </div>
                                            <div class="recent-post__content">
                                                <h3 class="recent-post__title text-truncate">
                                        ...
                                        <div class="recent-post__item">
                                            <div class="recent-post__thumb">
                                                <a href="single-post.html">
                                                    <img src="../view/assets/img/blog/blog_beuty2-70x70.jpg" alt="Blog">
                                                </a>
                                            </div>
                                            <div class="recent-post__content">
                                                <h3 class="recent-post__title text-truncate">
                                ...
                                <div class="widget blog-widget widget-archive mb--40">
                                    <h3 class="widget-title mb--25">Archives</h3>
                                    <ul class="widget-list category-list">
                                        <li>
                                            <a href="blog.html">
                                ...
                                <div class="widget blog-widget widget-meta mb--40">
                                    <h3 class="widget-title mb--25">Meta</h3>
                                    <ul class="widget-list category-list">
                                        <li>
                                            <a href="blog.html">
                                ...
                                <div class="widget blog-widget widget-tag">
                                    <h3 class="widget-title mb--25">Tags</h3>
                                    <div class="tagcloud">
                                        <a href="blog.html">Business</a>
                                        <a href="blog.html">Creative</a>
                        ...
                        <div class="col-12">
                            <div class="row mb--50">
                                <div class="col-12 text-center">
                                    <h2 class="heading__secondary">Related Post</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                                ...
                                                <div class="blog-media">
                                                    <figure class="image">
                                                        <a href="blog-details-image.html">
                                                            <img src="../view/assets/img/blog/blog-1.jpg" alt="Blog">
                                                        </a>
                                                    </figure>
                                                </div>
                                                <div class="blog-info">
                                                    <h2 class="blog-title">
                                                        <a href="single-post-image.html">She Belived She Could</a>
                                                    </h2>
                                                    <div class="blog-meta">
                                                        <div class="blog-meta--left">
                                                            <a href="blog-details-image.html" class="blog-meta-btn">
                                                        ...
                                                        <div class="blog-meta--right">
                                                            <a href="blog-details-image.html" class="btn btn-no-bg btn-color-dark">Read More <i class="fa fa-angle-double-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </article>
                                                ...
                                                <div class="blog-media">
                                                    <figure class="image">
                                                        <a href="single-post-image.html">
                                                            <img src="../view/assets/img/blog/blog-2.jpg" alt="Blog">
                                                        </a>
                                                    </figure>
                                                </div>
                                                <div class="blog-info">
                                                    <h2 class="blog-title">
                                                        <a href="single-post-image.html">Monday to Sunday</a>
                                                    </h2>
                                                    <div class="blog-meta">
                                                        <div class="blog-meta--left">
                                                            <a href="single-post-image.html" class="blog-meta-btn">
                                                                <i class="fa fa-comment-o"></i>
                                                                <sup>05</sup>
                                                            </a>
                                                            <a href="single-post-image.html" class="blog-meta-btn">
                                                        ...
                                                        <div class="blog-meta--right">
                                                            <a href="single-post-image.html" class="btn btn-no-bg btn-color-dark">Read More <i class="fa fa-angle-double-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </article>
                                        ...
                                        <div class="item">
                                            <article class="blog">
                                                <div class="blog-media">
                                                    <figure class="image">
                                                        <a href="blog-details-image.html">
                                                            <img src="../view/assets/img/blog/blog-3.jpg" alt="Blog">
                                                        </a>
                                                    </figure>
                                                </div>
                                                <div class="blog-info">
                                                    <h2 class="blog-title">
                                                        <a href="single-post-image.html">Trade Show Promotions</a>
                                                    </h2>
                                                    <div class="blog-meta">
                                                        <div class="blog-meta--left">
                                                            <a href="blog-details-image.html" class="blog-meta-btn">
